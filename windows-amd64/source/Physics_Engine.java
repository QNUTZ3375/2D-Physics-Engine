...
public void generateStaticObjects(int configNum){
  switch(configNum){
    case 1: 
      objects = new Shape[3];
    ...
    case 2: 
      ...
      //float x, float y, color c, boolean movable, float re, float radius, float width_, float height_, String type
      //left steep slope
      objects[0] = new Shape(55, height/2 - 60, color(0, 150, 150), false, 0.5f, 0, height - wallThickness * 18, wallThickness, "Box");
      objects[0].turn(-95);
      objects[0].getTransformedVertices();
      objects[0].currAABB = getAABB(objects[0]);
      //left slope
      objects[1] = new Shape(110, height - 280, color(0, 255, 150), false, 0.5f, 0, wallThickness * 6, wallThickness, "Box");
      objects[1].turn(-120);
      objects[1].getTransformedVertices();
      objects[1].currAABB = getAABB(objects[1]);
      //left gradual slope
      objects[2] = new Shape(222, height - 174, color(150, 0, 0), false, 0.5f, 0, wallThickness * 6, wallThickness, "Box");
      objects[2].turn(20);
      objects[2].getTransformedVertices();
      objects[2].currAABB = getAABB(objects[2]);
      //bottom middle slope (left)
      objects[3] = new Shape(500, height - 150, color(255, 150, 150), false, 0.5f, 0, wallThickness * 14, wallThickness, "Box");
      objects[3].currAABB = getAABB(objects[3]);
      //bottom right gradual slope
      objects[4] = new Shape(width - 222, height - 174, color(255, 150, 0), false, 0.5f, 0, wallThickness * 6, wallThickness, "Box");
      objects[4].turn(-20);
      objects[4].getTransformedVertices();
      objects[4].currAABB = getAABB(objects[4]);
      
      //right steep slope
      objects[5] = new Shape(width - 157, height/2 - 240, color(150, 150, 0), false, 0.5f, 0, height - wallThickness * 22, wallThickness, "Box");
      objects[5].turn(95);
      objects[5].getTransformedVertices();
      objects[5].currAABB = getAABB(objects[5]);
      //right slope
      objects[6] = new Shape(width - 210, height - 500, color(150, 255, 0), false, 0.5f, 0, wallThickness * 6, wallThickness, "Box");
      objects[6].turn(120);
      objects[6].getTransformedVertices();
      objects[6].currAABB = getAABB(objects[6]);
      //right gradual slope
      objects[7] = new Shape(width - 322, height - 394, color(0, 0, 150), false, 0.5f, 0, wallThickness * 6, wallThickness, "Box");
      objects[7].turn(-20);
      objects[7].getTransformedVertices();
      objects[7].currAABB = getAABB(objects[7]);
      //bottom middle slope (right)
      objects[8] = new Shape(width - 500, height - 370, color(150, 150, 255), false, 0.5f, 0, wallThickness * 8, wallThickness, "Box");
      objects[8].currAABB = getAABB(objects[8]);
      
      
      //top middle slope
      objects[9] = new Shape(400, 200, color(150, 150, 150), false, 0.5f, 0, wallThickness * 16, wallThickness, "Box");
      objects[9].turn(-20);
